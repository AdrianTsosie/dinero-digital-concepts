...
<html lang="en">
	<head>
		<meta charset ="utf-8">
		<title>Dinero Digital Concepts</title>
	</head>
	<body>
		<div>
			<img src="../img/ddc.png" width="450" height="450" alt="DDC Logo">
		</div>

		<h2>Purpose:</h2>
		<p>Dinero Digital Concepts is a multimedia design firm thay specializes in graphic design, web development,
			motion graphics, projection mapping and brand development.
		</p>
		<h2>Audience:</h2>
		<p>From small business owners to large corporations. Anyone who is looking for any from of digital media to help
			grow, promote and brand there company or idea.
		</p>
		<h2>Goal:</h2>
		<p>We would like to create a one on one relationship with our clients to help them create the visions they have.
